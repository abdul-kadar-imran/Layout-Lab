...
export default function Footer() {
    return (
        <footer className="relative z-10 w-full mt-auto pb-4 sm:pb-6 px-3 sm:px-6">
            {/* ── Main pill container ── */}
            <div
            ...
            >
                ...
                {/* ── Main content row ── */}
                <div
                    className="relative flex items-center justify-between px-4 sm:px-6 pt-4 pb-6 sm:pb-7"
                    style={{ zIndex: 6 }}
                >
    ...
    `,
                            ...
                            className="group relative flex h-[44px] w-[44px] sm:h-[52px] sm:w-[52px] flex-shrink-0 items-center justify-center select-none"
                            style={{
                                borderRadius: "50%",
                        ...
                        >
                            ...
                            {/* Portfolio Initial */}
                            <span
                                className="relative z-10 transition-all duration-300 group-hover:tracking-wider text-lg sm:text-[22px]"
                                style={{
                  ...
                  `,
                        ...
                        {/* Name block */}
                        <div className="flex flex-col justify-center select-none gap-[2px] sm:gap-1">
                            <span className="text-[8px] sm:text-[9px]" style={{
                            ...
                            <span className="text-[18px] sm:text-[22px]" style={{
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 flex-shrink-0">
                        ...
                        <motion.a
                            ...
                            whileTap={{ scale: 0.94 }}
                            className="relative flex h-[40px] w-[40px] sm:h-12 sm:w-12 items-center justify-center rounded-full cursor-pointer overflow-hidden"
                            style={{
                        ...
                        >
                            ...
                            <svg
                                ...
                                className="w-[16px] h-[16px] sm:w-[20px] sm:h-[20px] relative z-10"
                            >
